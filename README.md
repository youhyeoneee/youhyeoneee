...
소프트웨어의 동작을 이해하고 문제의 원인을 찾아 개선하는 SW 품질 검증 엔지니어입니다.

요구사항과 코드를 기반으로 테스트 범위와 실행 경로를 분석하고, 결함 원인을 추적하며 검증 업무를 수행하고 있습니다. </br>
반복적인 검증 과정에서 비효율을 발견하고 Python 기반 자동화 도구를 직접 개발해 검증 프로세스를 개선하는 데 관심이 있습니다.
